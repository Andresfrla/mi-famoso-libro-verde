...
export default function EditRecipeScreen() {
  ...
  const loadRecipe = useCallback(async () => {
    ...
    if (data) {
      setFormData({
        ...
        ingredients_es: data.ingredients_es.length > 0 ? data.ingredients_es : [''],
        ingredients_en: data.ingredients_en.length > 0 ? data.ingredients_en : [''],
        steps_es: data.steps_es.length > 0 ? data.steps_es : [''],
        steps_en: data.steps_en.length > 0 ? data.steps_en : [''],
  ...
  const handleSave = useCallback(async () => {
    ...
    const { error } = await updateRecipe(id, cleanedData);
